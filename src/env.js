...
export const env = createEnv({
	...
	server: {
		...
		MINIO_GALLERY_BUCKET_NAME: z.string(),
		MINIO_NEWS_BUCKET_NAME: z.string(),
	...
	runtimeEnv: {
		...
		MINIO_GALLERY_BUCKET_NAME: process.env.MINIO_GALLERY_BUCKET_NAME,
		MINIO_NEWS_BUCKET_NAME: process.env.MINIO_NEWS_BUCKET_NAME,
